...
def plot_tsne(tsne_results, output_path="loaded_data/tsne_scatter.png"):
    """
    Visualize t-SNE results as a scatter plot and save to file.
    
    Args:
        tsne_results: t-SNE coordinates, shape (N_genes, 2)
        output_path: Path to save the plot (default: loaded_data/tsne_scatter.png)
...
def plot_convex_hull(tsne_results, hull, output_path="loaded_data/tsne_convex_hull.png"):
    """
    ...
    Args:
        ...
        output_path: Path to save the plot (default: loaded_data/tsne_convex_hull.png)
...
def plot_bounding_box(tsne_results, bbox, output_path="loaded_data/tsne_bounding_box.png"):
    """
    ...
    Args:
        ...
        output_path: Path to save the plot (default: loaded_data/tsne_bounding_box.png)
...
def render_image(image, output_path="loaded_data/sample_expression_image.png", title="Expression Image"):
    """
    Save a single expression image to file.
    
    Args:
        image: 2D array representing an expression image, shape (w, h)
        output_path: Path to save the image (default: loaded_data/sample_expression_image.png)
